...
ndata3 <- filter(ndata2, SWMST.x-SWMST.y==0)
...
#output <- read.csv("ndata.csv")

#write.csv(ndata2, file="ndata2.csv", row.names = FALSE)
#output <- read.csv("ndata2.csv")

#write.csv(ndata3, file="ndata3.csv", row.names = FALSE)
output <- read.csv("ndata3.csv")

#write.csv(ndata5, file="ndata5.csv", row.names = FALSE)
#output <- read.csv("ndata5.csv")
...
ggplot(data = d, aes(Ncombined, cane_yield)) + 
  ...
  stat_smooth(method=lm, level=0.9) +
  facet_wrap(~Irrigation)+  ylim(0,8000) +
...
plot(lm(log10(yield) ~ Ncombined * as.factor(Irrigation), data = d), main = "Yield")
summary(lm(log10(yield) ~ Ncombined * as.factor(Irrigation), data = d), main="Yield")
...
summary(lm(sugar ~ Ncombined * as.factor(Irrigation), data = d), main = "Sugar")
...
plot(lm(log10(cane_yield) ~ Ncombined * as.factor(Irrigation), data = d), main = "Cane Yield")
summary(lm(log10(cane_yield) ~ Ncombined * as.factor(Irrigation), data = d), main = "Cane Yield")
...
summary(lm(cane_sugar ~ Ncombined * as.factor(Irrigation), data = d), main = "Cane % Sugar")
...
summary(lm(nitrogen_concentration ~ Ncombined * as.factor(Irrigation), data = d), main = "% Nitrogen")
...
```{r}
summary(nlme::lme(fixed = log(yield) ~ Ncombined * as.factor(Irrigation), random = ~1|ExpID, data = d, na.action = na.omit))
#summary(nlme::lme(fixed = log(yield) ~ sqrt(Ncombined) * as.factor(Irrigation), random = ~1|ExpID, data = d, na.action = na.omit))
```
## Total Sugar Content
```{r}
summary(nlme::lme(fixed = sugar ~ Ncombined * as.factor(Irrigation), random = ~1|ExpID, data = d, na.action = na.omit))
#summary(nlme::lme(fixed = sugar ~ sqrt(Ncombined) * as.factor(Irrigation), random = ~1|ExpID, data = d, na.action = na.omit))
```
### Cane_Yield
```{r}
summary(nlme::lme(fixed = log(cane_yield) ~ Ncombined * as.factor(Irrigation), random = ~1|ExpID, data = d, na.action = na.omit))
summary(nlme::lme(fixed = log(cane_yield) ~ sqrt(Ncombined) * as.factor(Irrigation), random = ~1|ExpID, data = d, na.action = na.omit))
```
### Sugar Content of Cane
```{r}
summary(nlme::lme(fixed = cane_sugar ~ Ncombined * as.factor(Irrigation), random = ~1|ExpID, data = d, na.action = na.omit))
#summary(nlme::lme(fixed = cane_sugar ~ sqrt(Ncombined) * as.factor(Irrigation), random = ~1|ExpID, data = d, na.action = na.omit))
```
## Nitrogen Concentration
```{r}
summary(nlme::lme(fixed = nitrogen_concentration ~ Ncombined * as.factor(Irrigation), random = ~1|ExpID, data = d, na.action = na.omit))
#summary(nlme::lme(fixed = nitrogen_concentration ~ sqrt(Ncombined) * as.factor(Irrigation), random = ~1|ExpID, data = d, na.action = na.omit))
```
